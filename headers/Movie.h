...
/**
 *  Helper method that puts the title on the heap
 *  and then assigns it to the movie. 
 */
void SetMovieTitle(MoviePtr movie, const char* title);
 ...
 */
Movie* CreateMovieFromRow(const char *dataRow);
